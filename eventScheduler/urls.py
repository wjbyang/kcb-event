...
urlpatterns = [
    ...
    path('v1/organization/<str:organization_id>/', views.OrganizationView.as_view(), name='organization_get_one'),
    path('v1/organizations/', views.ViewOrganization.as_view(), name='organization_get_all'),
