...
urlpatterns = [
    ...
    path('v1/organization/getall/', views.ViewOrganization.as_view(), name='organization_get_all'),
    path('v1/group/post/', views.GroupView.as_view(), name='group_post'),
    path('v1/group/getall/', views.ViewGroups.as_view(), name='group_get_all'),
    path('v1/event/post/', views.EventView.as_view(), name='event_post'),
    path('v1/event/get/<str:event_id>/', views.ViewEvent.as_view(), name='event_get'),
    path('v1/event/getall/', views.ViewEvents.as_view(), name='event_get_all'),
]